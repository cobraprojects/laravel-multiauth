...
namespace CobraProjects\Multiauth;
...
use CobraProjects\Multiauth\Exception\MultiAuthHandler;
use CobraProjects\Multiauth\Http\Middleware\AdminPermitTo;
use CobraProjects\Multiauth\Providers\AuthServiceProvider;
use CobraProjects\Multiauth\Console\Commands\PermissionCommand;
use CobraProjects\Multiauth\Http\Middleware\AdminPermitToParent;
use CobraProjects\Multiauth\Console\Commands\MakeMultiAuthCommand;
use CobraProjects\Multiauth\Console\Commands\RollbackMultiAuthCommand;
use CobraProjects\Multiauth\Http\Middleware\redirectIfAuthenticatedAdmin;
use CobraProjects\Multiauth\Http\Middleware\redirectIfNotWithRoleOfAdmin;
...
class MultiauthServiceProvider extends ServiceProvider
{
    public function boot()
    {
        if ($this->canHaveAdminBackend()) {
            ...
            $this->registerRoutes();
            $this->publisheThings();
            $this->mergeFileFrom(__DIR__ . '/../config/auth.php', 'auth');
            $this->mergeFileFrom(__DIR__ . '/../config/view.php', 'view');
    ...
    protected function mergeFileFrom($path, $key)
    {
    ...
    protected function publisheThings()
    {
        ...
        $this->publishes([
            ...
            __DIR__ . '/assets' => public_path('vendor/multiauth'),
        ], 'multiauth:views');
        $this->publishes([
