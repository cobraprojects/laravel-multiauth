 ...
 */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Redirect After Login route name
    |--------------------------------------------------------------------------
    |
    | It will redirect to a route name defined here after login.
    ...
    */
    'models' => [
        'admin'          => CobraProjects\Multiauth\Model\Admin::class,
        'role'           => CobraProjects\Multiauth\Model\Role::class,
        'permission'     => CobraProjects\Multiauth\Model\Permission::class,
    ],
];
